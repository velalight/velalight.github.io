...
const PRODUCTS=[
  {id:"1",name:"الشمعة الفاخرة (مجموعة 3 شموع)",nameEn:"Luxury Candle Set (3 Candles)",cat:"wood",price:650,old:750,badge:"خصم",badgeEn:"Sale",hours:"3 شموع × 72 ساعة",hoursEn:"3 candles × 72h",scents:["عود","فانيليا","مسك أبيض"],img:"velalight-wooden-luxury-set-3candles-angle.webp",imgs:["velalight-wooden-luxury-set-3candles-packaging.webp","velalight-wooden-pumpkin-spice-detail.webp","velalight-wooden-luxury-set-3candles-lifestyle.webp","velalight-wooden-luxury-set-3candles-detail.webp","velalight-wooden-pumpkin-spice-main.webp"],sold:0,createdAt:NOW-1*D,desc:"ثلاث شموع فاخرة في مجموعة واحدة، صُممت لتتناغم معًا كسيمفونية من الضوء والعطر.",descEn:"Three luxury candles in one curated set."},
