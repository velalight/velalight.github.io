...
const PRODUCTS=[
  {id:"1",name:"الشمعة الفاخرة (مجموعة 3 شموع)",nameEn:"Luxury Candle Set (3 Candles)",cat:"wood",price:650,old:750,badge:"خصم",badgeEn:"Sale",hours:"3 شموع × 72 ساعة",hoursEn:"3 candles × 72h",scents:["عود","فانيليا","مسك أبيض"],img:"velalight-wooden-luxury-set-3candles-detail.webp",imgs:["velalight-wooden-luxury-set-3candles-detail.webp","velalight-wooden-luxury-set-3candles-detail.webp","velalight-wooden-luxury-set-3candles-detail.webp","velalight-wooden-luxury-set-3candles-detail.webp","velalight-wooden-luxury-set-3candles-detail.webp"],sold:0,createdAt:NOW-1*D,desc:"ثلاث شموع فاخرة في مجموعة واحدة، صُممت لتتناغم معًا كسيمفونية من الضوء والعطر.",descEn:"Three luxury candles in one curated set."},
...
const I18N={
  ar:{
    ...
    hero_a:"ضوء يُحكى…",
    hero_b:"وبريق يليق بك",
    hero_lead:"في VelaLight كل شمعة اتصنعت يدويًا بعناية.",
    cta_shop:"اكتشف The Collection ✨",
    cta_story:"Our Story",

    hero_eyebrow:"✦ شموع يدوية فاخرة",
    hero_t1:"ضوءٌ",
    hero_t2:"يُشبهك.",
    hero_desc:"شموع هاند ميد بتصميمات مختلفه وروائح على ذوقك - كل شمعه معموله علشان تضيف لمكانك احساس مختلف.",
    hero_btn1:"اختر شمعتك ✨",
    ...
    stock_left:"⚡ باقي {n} فقط — اطلب الآن!",
    stock_available:"متاح",
    stock_out:"نفدت الكمية",

    about_h2:"من نحن",
    about_p1:"حكايتنا بدأت من حبنا للتفاصيل الصغيرة… من إيماننا إن نور بسيط ممكن يهدّي الروح، وإن ريحة حلوة ممكن تاخدك في لحظة لذكرى بتحبها.\n\nومع الوقت، الشغف ده كبر وبقى ورشة بنشتغل فيها على كل شمعة بهدوء وحب، وكل قطعة بتتعمل بإيدينا، واحدة واحدة… زي رسالة بنكتبها لحد غالي علينا.",

    about_p2:"بنختار لك شمع طبيعي ونقي، وفتايل خشب وقطن آمنة ومناسبة لبيتك، ونستخدم أرقى العطور بعناية، عشان كل شمعة يكون لها حضورها الخاص وإحساسها المختلف.\n\nوبنهتم بكل تفصيلة لحد آخر خطوة، من أول الشمعة لحد التغليف… لأننا مؤمنين إن الأناقة الحقيقية بتبدأ من التفاصيل.\n\nشموعنا مش معمولة عشان تتستخدم وخلاص… هي معمولة عشان تعيش معاها لحظة.\n\nتنور ركن بتحبه، تكمل فرحتك في يوم مميز، أو تضيف لمسة دافية ليوم عادي وتخليه أحلى.\n\nVelaLight… نور يشبهك، وعطر يفضل فاكرك.",
...
faq8a:"نظرًا لطبيعة منتجاتنا المصنوعة يدويًا، لا يمكن الاستبدال أو الاسترجاع بعد فتح المنتج أو استخدامه، أو بسبب تغيير الرغبة بعد تأكيد الطلب. وفي حالة وصول المنتج بعيب مصنعي أو تلف بسبب الشحن، يرجى التواصل معنا خلال 24 ساعة من الاستلام وسنعمل على حل المشكلة.",
    ...
    rev_cta:"✨ جربت سحرنا؟",
    rev_cta_link:"ابعتلنا رأيك على الواتساب",
    rev_back_home: "← الرجوع للرئيسية",
    rev_stat_label: "تجربة عميل",
    rev_cta_title: "جاهز تنضم لعائلة VelaLight؟ 🕯️",
    rev_cta_desc: "اختر شمعتك الفاخرة واصنع لحظتك الخاصة",
    rev_cta_btn: "تسوق الآن 🛍️",
    rev_rating_title: "تقييم العملاء",
    rev_testimonial_title: "ثقة تتجدد",
    rev_testimonial_text: "مش مجرد شمعة… دي لحظة بتتعاش!",
    rev_testimonial_author: "— أحد عملائنا",
...
paymethod_d:"💳 سيتم إرسال تفاصيل الدفع المتاحة (InstaPay / فودافون كاش / أورنج كاش / تحويل بنكي) عبر الواتساب فور تأكيد الطلب.",
    ...
    cart_empty_sub:"اكتشف The Collection",
    scent_lbl:"العطر:",
    ...
    pd_first:"كن أول من يراجع",
    pd_form_t:"أضف مراجعتك ⭐",
    pd_name_ph:"اسمك",
    pd_text_ph:"اكتب رأيك...",
    ...
    stock_remaining:"⚡ باقي {n} فقط — اطلب الآن!",

    chat_name:"مساعد VelaLight",
    chat_sub:"دليلك الشخصي",
    chat_welcome:"أهلًا بك ✨",
    q_gift:"اقترح لي هدية",
    q_relax:"عايز حاجة للاسترخاء",
    ...
    t_fill:"⚠️ كمّل البيانات",
    t_empty:"السلة فاضية 🕯️",
    t_order:"✅ تم تسجيل طلبك",
    t_revok:"💛 شكرًا!",
    t_revwarn:"⚠️ اكتب اسمك ومراجعتك",
    t_trkwarn:"⚠️ دخّل رقم الطلب",
    t_saved:"💾 تم الحفظ",
    t_lang_ar:"تم التحويل للعربية",
    t_lang_en:"English",
    t_confirm_empty:"هتفضّي السلة؟",
    t_confirm_del:"متأكد؟",
    t_go_cart:"🛍️ اذهب للسلة",
    ...
    t_scentwarn:"⚠️ من فضلك اختر العطر قبل الإضافة"
  },
...
faq8a:"Due to the nature of our handmade products, returns or exchanges are not accepted after the product has been opened or used, or due to a change of mind after the order has been confirmed. If your order arrives with a manufacturing defect or shipping damage, please contact us within 24 hours of delivery and we will be happy to resolve the issue.",
    ...
    rev_cta_link:"Send us your review on WhatsApp",
        rev_back_home: "← Back to Home",
    rev_stat_label: "Customer Experience",
    rev_cta_title: "Ready to join the VelaLight family? 🕯️",
    rev_cta_desc: "Choose your luxury candle and create your special moment",
    rev_cta_btn: "Shop Now 🛍️",
    rev_rating_title: "Customer Ratings",
    rev_testimonial_title: "Renewed Trust",
    rev_testimonial_text: "Not just a candle... it's a moment to be lived!",
    rev_testimonial_author: "— One of our customers",
